...
pub enum UpdateAction {
    /// Update via `npm install -g @ltn/codex@latest`.
    NpmGlobalLatest,
    /// Update via `bun install -g @ltn/codex@latest`.
    BunGlobalLatest,
...
impl UpdateAction {
    ...
    pub fn command_args(self) -> (&'static str, &'static [&'static str]) {
        match self {
            UpdateAction::NpmGlobalLatest => ("npm", &["install", "-g", "@ltn/codex@latest"]),
            UpdateAction::BunGlobalLatest => ("bun", &["install", "-g", "@ltn/codex@latest"]),
