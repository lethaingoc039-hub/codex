...
| `config`                | object | Individual [config settings](https://github.com/lethaingoc039-hub/codex/blob/main/docs/config.md#config) that will override what is in `$CODEX_HOME/config.toml`. |
